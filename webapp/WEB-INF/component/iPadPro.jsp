	...
	<div class = "main">
		...
		<div class = "ready_container container">
			<div class = "ready_image_box">
				<div class = "ready_image"></div>
			</div>
			<div class = "ready_info_box">
				<div class = "ready_info_title">궁극의 iPad 경험. 그리고 이제 그 바탕 위에 더해진 혁신적인<br>M1 성능, 경이로운 XDR 디스플레이, 쏜살같이 빠른 5G 무선<br>스피드까지. 놀랄 준비 되셨나요?</div>
		...
		<div class = "chip_container container">
			...
			M1 칩. M1이 장착된 iPad Pro는 비교를 불허하는 독보적으로<br>빠른 속도를 자랑합니다. M1의 첨단 이미지 신호 프로세서와 통합<br>메모리 아키텍처 같은 맞춤형 기술 그리고 차원이 다른 성능을<br>최대한 활용하도록 설계되었죠. 게다가 M1의 놀라운 전력 효율성<br>덕분에 iPad Pro는 여전히 얇고 가벼운 디자인에 온종일 가는<br>배터리를 갖추고 있습니다.1 으뜸인 성능만큼이나 휴대성도<br>으뜸이죠.
			</div>
			...
			<div class = "display_image_box">
				<div class = "display_image">
					<div class = "display_info_box">
						...
						눈이 즐겁다. 손이 즐겁다. 11형 iPad Pro의 Liquid Retina 디스플레이는 아름답고 휴대성이 뛰어날 뿐만 아니라 놀라운 최첨단 기술까지 갖추고 있습니다.2 ProMotion, True Tone, P3의 넓은 색영역, 초저 반사율 덕분에 화면 위에 펼쳐지는 모든 것이 아름답게 보이고, 뛰어난 반응성을 자랑하죠.
						</div>
