...
<body> 
	...
	<div class="product_wrapper">
		<div class="product mac_main_iMac">
			...
			<div class="mac_main_iMac iMac_image"></div>
		</div>
	</div>
	<!-- Mac 라인 제품 비교 -->
	...
	<div class="mac_Accessories_credit_wrapper">
		...
		<div class="mac_credit_wrapper">
			...
			<div class="mac_credit subtitle_wrapper">
				<div class="mac_credit subtitle">보상 판매 대상 컴퓨터를 크레딧으로 교환해드리거나, 무상으로 재활용해드립니다. 당신은 물론 지구에게도 좋은 일이죠.</div>
				<div class="mac_credit subtitle_note_num">9</div>
			</div>
			<div class="button more_info_wrapper mac_credit_info_button_wrapper">
				<div class="more_info_wrapper mac_credit_info">보상 판매 가격 알아보기</div>
				<div class="more_info_wrapper mac_credit_info_icon"></div>
			</div>
		</div>
	</div>
	<!-- macOS Monterey -->
	...
	<div class="delivery_benefits_help_wrapper">
		<div class="col delivery_wrapper">
			...
			<div class="button more_info_wrapper">
				<div class="delivery_info">더 알아보기</div>
				<div class="more_info_icon"></div>
			</div>
		</div>
		...
		<div class="mac_promo_section_wrapper">
			...
			<div class="mac_promo section num2">
				...
				<div class="mac_promo button section_2 more_info_wrapper">
					...
					<div class="button section_2 more_info_sub_wrapper">
						<div class="more_info">지금 업데이트하기</div>
	...
	<div class="get_more_promo_section">
		...
		<div class="online_session_section">
			<div class="online_session_title_wrapper">
				...
				<div class="button more_info_wrapper get_more_promo_section">
					<div class="more_info">등록하기</div>
					<div class="more_info_icon"></div>
				</div>
			</div>
			<div class="online_session_image"></div>
		</div>
		...
		<div class="Apple_Arcade_section">
			<div class="Apple_Arcade_title_wrapper">
				...
				<div class="button more_info_wrapper get_more_promo_section">
					<div class="button more_info_wrapper">
						<div class="more_info">무료 체험하기</div>
						<div class="Apple_Arcade subtitle_note_num">10</div>
						<div class="arrow_icon"></div>
					</div>
					<div class="button more_info_wrapper">
						<div class="more_info">더 알아보기</div>
			...
			<div class="Apple_Arcade_session_image"></div>
		</div>
	</div>
	<!-- Apple과 교육 -->
	<div class="education">
