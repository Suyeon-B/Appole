...
<body> 
	...
	<div class="product_wrapper">
		<div class="product mac_main_iMac">
			...
			<div class="mac_main_iMac title">iMac</div>
			...
			<div class="laptop_models MacBook_Air">
				...
				<div class="MacBook_Air info_detail">
					<div class="info_detail inch">
						...
						<div class="inch_subtitle_wrapper">
					...
					<div class="info_detail capacity">
						...
						<div class="capacity_subtitle_wrapper">
					...
					<div class="info_detail battery">
						...
						<div class="icon_subtitle_wrapper">
							<div class="icon subtitle">최대 18시간의 배터리 사용 시간</div>
							<div class="icon subtitle_note_num">3</div>
						</div>
					</div>
				...
				<div class="MacBook_Air more_info_wrapper">
			...
			<div class="laptop_models MacBook_Pro_13">
				...
				<div class="MacBook_Pro_13 info_detail">
					...
					<div class="info_detail battery">
						...
						<div class="icon_subtitle_wrapper">
							<div class="icon subtitle">최대 18시간의 배터리 사용 시간</div>
							<div class="icon subtitle_note_num">5</div>
						</div>
					</div>
					<div class="info_detail camera">
						<div class="camera icon"></div>
				...
				<div class="MacBook_Pro_13 more_info_wrapper">
					<div class="more_info">더 알아보기</div>
					<div class="more_info_icon"></div>
				</div>
			</div>
			...
			<div class="laptop_models MacBook_Pro_16">
				...
				<div class="MacBook_Pro_16 info_detail">
					...
					<div class="info_detail battery">
						<div class="battery icon"></div>
						<div class="icon_subtitle_wrapper">
							<div class="icon subtitle">최대 11시간의 배터리 사용 시간</div>
							<div class="icon subtitle_note_num">6</div>
						</div>
					</div>
					<div class="info_detail camera">
						<div class="camera icon"></div>
				...
				<div class="MacBook_Pro_16 more_info_wrapper">
					<div class="more_info">더 알아보기</div>
					<div class="more_info_icon"></div>
				</div>
			</div>
